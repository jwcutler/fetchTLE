<?php
/*
This controller is responsible for ground station management functionality.
*/
...
class StationController extends AppController {
    ...
    public function admin_add(){
        /*
        Displays the form to add a new ground station.
        */
        
        $this->set("title_for_layout", "Add a Ground Station");
    }
